var savtaleApp = angular.module ("savtaleApp" , ['slick', 'angular.filter']);


savtaleApp.controller('savtaleCtrl', ['$scope', '$http', function($scope, $http) {
...
var searchObj = getParameterByName('id');
    ...
    $scope.meals;
        ...
        $http.get("https://savtale.herokuapp.com/getillnessData/11").success(function (data) {
        $scope.illness = data;
        console.log(data);
    });
